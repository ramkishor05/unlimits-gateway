...
@Entity
@Table
public class EOFinanacialPreparation implements Serializable {
	...
	public List<EOFinanacialPreparationRecipe> preparationRecipes;
	...
	public List<EOFinanacialPreparationRecipe> getPreparationRecipes() {
		return preparationRecipes;
	}

	public void setPreparationRecipes(List<EOFinanacialPreparationRecipe> preparationRecipes) {
