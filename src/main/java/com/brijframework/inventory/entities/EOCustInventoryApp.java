...
import static com.brijframework.inventory.contants.Constants.APP_ID;
import static com.brijframework.inventory.contants.Constants.CUST_ID;
import static com.brijframework.inventory.contants.Constants.CUST_PRODUCTION_APP;
import static com.brijframework.inventory.contants.Constants.EOCUST_INVENTORY_APP;
...
@Table(name = EOCUST_INVENTORY_APP, uniqueConstraints = {@UniqueConstraint (columnNames = { APP_ID, CUST_ID })})
public class EOCustInventoryApp extends EOCustObject {
